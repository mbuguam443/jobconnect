...
SECRET_KEY = 'django-insecure-4og-7@wcao_f*o2bdb)z6^+$&dp4tq8+lf%d8hq-su-m540kh2'
...
ALLOWED_HOSTS = ['*']  # or ['jobfinder.onrender.com']

STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Where your theme assets are
